...
def test_fresh_store_bootstraps_canonical_semantic_state_from_bound_provider(tmp_path, monkeypatch):
    ...
    operator_controls.install_operator_control_plane(
        app, maintenance_state_provider=lambda: {"motion_blocked": False, "recovery_required": False},
        reference_state_provider=lambda: {"rows": {}}, lifecycle_state_provider=lambda: {},
