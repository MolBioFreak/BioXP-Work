...
def test_gripper_profile_reports_machine_config_positions_and_source_anchor(monkeypatch):
    from src.bioxp import oem_gripper
    ...
    monkeypatch.setattr(
        ...
        lambda: {
            "ok": True,
            "config_path": "/immutable/test/config.xml",
            "gripper": {
                "originOffsetG": {"value": 4450},
                "GripperClosePOS": {"value": 27350},
                "GripperOpenPOS": {"value": 31400},
                "GripperOpenWide": {"value": 32400},
            },
        },
    )

    payload = oem_gripper.gripper_status(FakeTester(position=49))
